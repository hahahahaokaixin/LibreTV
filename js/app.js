// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ckzy", "jkun", "bwzy", "souav", "r155", "lsb", "huangcang", "yutu"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["ckzy", "jkun", "bwzy", "souav", "r155", "lsb", "huangcang", "yutu"];
